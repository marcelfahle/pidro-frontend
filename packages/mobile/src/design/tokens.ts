...
export const PidroBevel = {
  ...
  woodFaceGradient: 'linear-gradient(180deg, #B57A31 0%, #91541C 42%, #6C370E 78%, #4E2509 100%)',
  glassRimGradient:
  ...
  woodGlossGradient:
    'linear-gradient(180deg, rgba(255,248,225,0.24) 0%, rgba(255,248,225,0.07) 100%)',
  glassGlossGradient:
