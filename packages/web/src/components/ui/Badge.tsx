...
const variantClasses = {
  green: 'border border-emerald-300/40 bg-emerald-500/18 text-emerald-100 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)]',
  ...
  yellow: 'border border-[#ffcc54]/50 bg-[#d98e13]/22 text-[#fff0b2] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)]',
