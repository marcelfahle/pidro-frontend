    ...
    <div className="pidro-page">
      <div className="pidro-window flex h-dvh flex-col items-center justify-center overflow-x-hidden overflow-y-auto px-5 py-4 max-sm:justify-start max-sm:px-4 max-sm:pt-0">
        <img
          src={pidroLogoUrl}
          alt="Pidro"
          className="pointer-events-none w-[300px] select-none drop-shadow-[0_0_36px_rgba(0,160,255,0.35)] max-sm:mt-6 max-sm:w-[230px]"
        />

        <div className="mt-6 w-full max-w-[380px] max-sm:mt-5">
          <GlassCard style={{ padding: 20 }}>
            ...
            <div className="my-4 flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.18em] text-cyan-50/45">
                or
              </span>
              <div className="h-px flex-1 bg-cyan-200/20" />
            </div>
          ...
          <div className="mt-3 space-y-2.5">
            <Link to="/register" className="block">
              <GlassButton fullWidth>Create Account</GlassButton>
            </Link>

            <Link
              to="/tutorial"
              className="group flex w-full items-center justify-center gap-2 rounded-[var(--pidro-radius-surface)] border border-dashed border-cyan-400/30 bg-cyan-500/5 px-3 py-2.5 text-[12px] font-bold text-cyan-200/75 transition-all hover:border-cyan-400/50 hover:bg-cyan-500/10 hover:text-cyan-100"
            >
              <svg
                aria-hidden="true"
                className="h-4 w-4 shrink-0 text-cyan-400/60 transition-colors group-hover:text-cyan-300"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
